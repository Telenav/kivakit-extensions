...
public abstract class PrimitiveMultiMap extends PrimitiveMap
{
    ...
    {
        String toString(long key, com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator value);
    }
    ...
    protected String toString(final com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator keys, final Keyed<Long, com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator> values,
                              final MultiMapToString toStringer)
    {
        return Indent.by(4, toString(keys, values, ", ", 5, "\n", toStringer));
    }

    protected String toString(final com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator keys, final Keyed<Long, PrimitiveIterator> values,
