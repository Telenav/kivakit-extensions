...
import com.telenav.kivakit.collections.primitive.array.PrimitiveSplitArray;
import com.telenav.kivakit.collections.primitive.ByteCollection;
 ...
 * {@link ByteList} are supported just as in {@link com.telenav.kivakit.collections.primitive.array.scalars.ByteArray}, but the values are distributed across an array of child
 * {@link com.telenav.kivakit.collections.primitive.array.scalars.ByteArray} objects.
 *
 * @author jonathanl (shibo)
 * @see com.telenav.kivakit.collections.primitive.array.PrimitiveSplitArray
 * @see ByteList
...
{
    /** The child arrays */
    private com.telenav.kivakit.collections.primitive.array.scalars.ByteArray[] children;
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        children = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.ByteArray[].class);
    ...
    public ByteList sublist(final int offset, final int size)
    {
        ...
        return new com.telenav.kivakit.collections.primitive.array.scalars.ByteArray(objectName() + "[" + offset + " - " + (offset + size - 1) + "]")
        {
            @Override
            public byte[] asArray()
            {
    ...
    protected void onInitialize()
    {
        super.onInitialize();
        childSize = initialChildSizeAsInt();
        children = new com.telenav.kivakit.collections.primitive.array.scalars.ByteArray[initialChildCountAsInt()];
    }
