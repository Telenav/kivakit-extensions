...
{
    /** The array of arrays */
    private com.telenav.kivakit.collections.primitive.list.store.IntLinkedListStore values;
    ...
    public void add(final long key, final int value)
    {
        if (ensureHasRoomFor(1))
        {
            ...
            final var head = indexes.isNull(index) ? com.telenav.kivakit.collections.primitive.list.store.IntLinkedListStore.NEW_LIST : index;
    ...
    {
        final var array = new com.telenav.kivakit.collections.primitive.array.scalars.IntArray("get");
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        values = kryo.readObject(input, com.telenav.kivakit.collections.primitive.list.store.IntLinkedListStore.class);
