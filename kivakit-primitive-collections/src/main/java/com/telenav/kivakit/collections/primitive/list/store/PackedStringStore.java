...
public class PackedStringStore extends PrimitiveCollection
{
    ...
    private com.telenav.kivakit.collections.primitive.array.scalars.SplitIntArray indexes;
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        indexes = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.SplitIntArray.class);
    }
