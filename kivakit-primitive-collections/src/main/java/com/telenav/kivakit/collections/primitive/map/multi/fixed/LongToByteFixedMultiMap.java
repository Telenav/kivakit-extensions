 ...
 * @see com.telenav.kivakit.collections.primitive.array.scalars.ByteArray
...
public final class LongToByteFixedMultiMap extends PrimitiveMultiMap implements PrimitiveScalarMultiMap
{
    ...
    private com.telenav.kivakit.collections.primitive.array.scalars.ByteArray values;
     ...
     */
    public com.telenav.kivakit.collections.primitive.array.scalars.ByteArray get(final long key)
    {
        final var index = indexes.get(key);
        if (!indexes.isNull(index))
        {
            final var values = new com.telenav.kivakit.collections.primitive.array.scalars.ByteArray("get");
     ...
     * Puts the given values under the given key
     */
    public void putAll(final long key, final com.telenav.kivakit.collections.primitive.array.scalars.ByteArray values)
    {
    ...
    {
        putAll(key, (com.telenav.kivakit.collections.primitive.array.scalars.ByteArray) values);
    }
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        values = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.ByteArray.class);
