...
package com.telenav.kivakit.collections.primitive.map.scalars;
 ...
 * @see com.telenav.kivakit.collections.primitive.map.PrimitiveMap
 * @see KryoSerializable
 */
@UmlClassDiagram(diagram = DiagramPrimitiveMap.class)
public final class IntToIntMap extends com.telenav.kivakit.collections.primitive.map.PrimitiveMap implements PrimitiveScalarMap
{
     ...
     */
    public com.telenav.kivakit.collections.primitive.iteration.IntIterator keys()
    {
     ...
     */
    public com.telenav.kivakit.collections.primitive.iteration.IntIterator values()
    {
    ...
    @Override
    protected void compare(final com.telenav.kivakit.collections.primitive.map.PrimitiveMap map)
    {
     ...
     */
    @Override
    protected void copy(final com.telenav.kivakit.collections.primitive.map.PrimitiveMap uncast)
    {
        super.copy(uncast);
    ...
    private int compare(final IntToIntMap that)
    {
        ...
        final com.telenav.kivakit.collections.primitive.iteration.IntIterator keys = keys();
        int count = 0;
        while (keys.hasNext())
        {
            final var key = keys.next();
