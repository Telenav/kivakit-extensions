...
public interface PrimitiveScalarMultiMap
{
     ...
     */
    com.telenav.kivakit.collections.primitive.list.PrimitiveList getPrimitiveList(long key);

    /**
     * @return A list of primitives for the given key, or null if there is none
     */
    default com.telenav.kivakit.collections.primitive.list.PrimitiveList getSignedPrimitiveList(final long key)
    {
