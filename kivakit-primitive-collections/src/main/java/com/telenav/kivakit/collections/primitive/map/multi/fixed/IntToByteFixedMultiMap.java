...
public final class IntToByteFixedMultiMap extends PrimitiveMultiMap implements PrimitiveScalarMultiMap
{
     ...
     */
    public com.telenav.kivakit.collections.primitive.array.scalars.ByteArray get(final int key)
    {
     ...
     * Puts the given values under the given key
     */
    public void putAll(final int key, final com.telenav.kivakit.collections.primitive.array.scalars.ByteArray values)
    {
    ...
    {
        putAll((int) key, (com.telenav.kivakit.collections.primitive.array.scalars.ByteArray) values);
    }
