...
package com.telenav.kivakit.collections.primitive.map.multi.dynamic;
...
{
    /** The array of arrays */
    private com.telenav.kivakit.collections.primitive.list.store.LongLinkedListStore values;

    /** Map from key to lists index */
    private com.telenav.kivakit.collections.primitive.map.split.SplitLongToIntMap indexes;
    ...
    public void add(final long key, final long value)
    {
        if (ensureHasRoomFor(1))
        {
            ...
            final var head = indexes.isNull(index) ? com.telenav.kivakit.collections.primitive.list.store.LongLinkedListStore.NEW_LIST : index;
    ...
    {
        final var array = new com.telenav.kivakit.collections.primitive.array.scalars.LongArray("get");
     ...
     */
    public com.telenav.kivakit.collections.primitive.iteration.LongIterator iterator(final long key)
    {
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        values = kryo.readObject(input, com.telenav.kivakit.collections.primitive.list.store.LongLinkedListStore.class);
        indexes = kryo.readObject(input, com.telenav.kivakit.collections.primitive.map.split.SplitLongToIntMap.class);
    }
