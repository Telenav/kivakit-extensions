...
/**
 * A dynamic array of primitive byte values. Supports the indexing operations in {@link com.telenav.kivakit.collections.primitive.list.ByteList}. Expands the size of
 * the array if you call {@link #set(int, byte)} or {@link #add(byte)} and the array is not big enough.
 * <p>
 * Constructors take the same name, maximum size and estimated capacity that all {@link com.telenav.kivakit.collections.primitive.PrimitiveCollection}s take. In
 ...
 * @see com.telenav.kivakit.collections.primitive.PrimitiveCollection
 * @see com.telenav.kivakit.collections.primitive.list.ByteList
