 ...
 *     <li>{@link #keys()}</li>
 *     <li>{@link #values()}</li>
 *     <li>{@link #entries(com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap.EntryVisitor)} </li>
...
{
    private com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap[] children;
     ...
     */
    public void entries(final com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap.EntryVisitor visitor)
    {
        for (final var child : children)
        {
            if (child != null)
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        children = kryo.readObject(input, com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap[].class);
    ...
    {
        super.onInitialize();
        children = new com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap[initialChildCountAsInt()];
    }

    /**
     * @return Gets the child map for the given key. If there is no map, one is created if create is true.
     */
    private com.telenav.kivakit.collections.primitive.map.scalars.LongToIntMap child(final long key, final boolean create)
    {
