...
import com.telenav.kivakit.collections.primitive.map.multi.IntMultiMap;
 ...
 * @see com.telenav.kivakit.collections.primitive.array.scalars.IntArray
...
public final class IntToIntFixedMultiMap extends PrimitiveMultiMap implements IntMultiMap, PrimitiveScalarMultiMap
{
    ...
    private com.telenav.kivakit.collections.primitive.array.scalars.IntArray values;
     ...
     */
    public com.telenav.kivakit.collections.primitive.array.scalars.IntArray get(final int key)
    {
        final var index = indexes.get(key);
        if (!indexes.isNull(index))
        {
            final var values = new com.telenav.kivakit.collections.primitive.array.scalars.IntArray("get");
    ...
    @Override
    public com.telenav.kivakit.collections.primitive.array.scalars.IntArray get(final long key)
    {
        return get((int) key);
    }
    ...
    @Override
    public void putAll(final long key, final com.telenav.kivakit.collections.primitive.array.scalars.IntArray values)
    {
     ...
     * Puts the given values under the given key
     */
    public void putAll(final int key, final com.telenav.kivakit.collections.primitive.array.scalars.IntArray values)
    {
        // If we haven't already put a value for this key
        assert isNull(indexes.get(key));
    ...
    {
        putAll((int) key, (com.telenav.kivakit.collections.primitive.array.scalars.IntArray) values);
    }
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        values = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.IntArray.class);
