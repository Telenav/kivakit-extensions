...
import com.telenav.kivakit.collections.primitive.array.PrimitiveArrayArray;
...
import com.telenav.kivakit.collections.primitive.iteration.LongIterable;
...
/**
 * Optimized storage of two dimensional long arrays. A sequence of {@link com.telenav.kivakit.collections.primitive.array.scalars.LongArray} objects can be added by calling
...
public final class LongArrayArray extends PrimitiveArrayArray
{
    ...
    private com.telenav.kivakit.collections.primitive.array.scalars.LongArray store;
    ...
    /**
     * Adds the given values and returns an identifier that can be used to retrieve the values as a {@link com.telenav.kivakit.collections.primitive.array.scalars.LongArray}
     * with {@link #get(int)}.
     *
     ...
     */
    public com.telenav.kivakit.collections.primitive.array.scalars.LongArray get(final int identifier)
    {
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        store = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.LongArray.class);
    }
