...
package com.telenav.kivakit.collections.primitive;
...
import com.telenav.kivakit.collections.primitive.list.store.PrimitiveListStore;
    ...
    protected PrimitiveCollection(final String objectName)
    {
        ...
        if (logAllocations())
        {
            ...
            if (initialSize > LARGE_ALLOCATION)
            {
                ...
                if (this instanceof PrimitiveMultiMap || this instanceof com.telenav.kivakit.collections.primitive.array.PrimitiveArrayArray)
                {
                    if (DEBUG.isDebugOn())
                    {
