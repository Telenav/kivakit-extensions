...
public final class DefaultHashingStrategy implements com.telenav.kivakit.collections.primitive.map.HashingStrategy
{
    public static com.telenav.kivakit.collections.primitive.map.HashingStrategy DEFAULT = of(Estimate._1024);
