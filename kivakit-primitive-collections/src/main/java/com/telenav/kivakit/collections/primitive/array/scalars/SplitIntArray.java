...
import com.telenav.kivakit.collections.primitive.IntCollection;
 ...
 * {@link IntList} are supported just as in {@link com.telenav.kivakit.collections.primitive.array.scalars.IntArray}, but the values are distributed across an array of child
 * {@link com.telenav.kivakit.collections.primitive.array.scalars.IntArray} objects.
 *
...
{
    /** The child arrays */
    private com.telenav.kivakit.collections.primitive.array.scalars.IntArray[] children;
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        children = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.IntArray[].class);
    ...
    protected void onInitialize()
    {
        super.onInitialize();
        childSize = initialChildSizeAsInt();
        children = new com.telenav.kivakit.collections.primitive.array.scalars.IntArray[initialChildCountAsInt()];
    }
