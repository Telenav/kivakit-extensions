...
package com.telenav.kivakit.collections.primitive.array.bits;
...
import com.telenav.kivakit.collections.primitive.array.bits.io.input.BaseBitReader;
import com.telenav.kivakit.collections.primitive.array.bits.io.output.BaseBitWriter;
...
{
    /** The byte array */
    private com.telenav.kivakit.collections.primitive.list.ByteList bytes;
    ...
    public BitArray(final String objectName, final com.telenav.kivakit.collections.primitive.list.ByteList bytes)
    {
        super(objectName);
        this.bytes = bytes;
        offset = bytes.cursor();
