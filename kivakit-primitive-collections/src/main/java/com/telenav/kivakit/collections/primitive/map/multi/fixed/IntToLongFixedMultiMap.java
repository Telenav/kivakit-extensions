...
package com.telenav.kivakit.collections.primitive.map.multi.fixed;
...
import com.telenav.kivakit.collections.primitive.map.multi.LongMultiMap;
import com.telenav.kivakit.collections.primitive.map.multi.PrimitiveMultiMap;
 ...
 * @see com.telenav.kivakit.collections.primitive.array.scalars.LongArray
 * @see com.telenav.kivakit.collections.primitive.map.multi.PrimitiveMultiMap
...
public final class IntToLongFixedMultiMap extends PrimitiveMultiMap implements LongMultiMap, PrimitiveScalarMultiMap
{
    ...
    private com.telenav.kivakit.collections.primitive.array.scalars.LongArray values;
     ...
     */
    public com.telenav.kivakit.collections.primitive.array.scalars.LongArray get(final int key)
    {
        final var index = indexes.get(key);
        if (!indexes.isNull(index))
        {
            final var values = new com.telenav.kivakit.collections.primitive.array.scalars.LongArray("get");
    ...
    @Override
    public com.telenav.kivakit.collections.primitive.array.scalars.LongArray get(final long key)
    {
        return get((int) key);
    }

    @Override
    public com.telenav.kivakit.collections.primitive.list.PrimitiveList getPrimitiveList(final long key)
    {
        return get((int) key);
    }
    ...
    @Override
    public void putAll(final long key, final com.telenav.kivakit.collections.primitive.array.scalars.LongArray values)
    {
     ...
     * Puts the given values under the given key
     */
    public void putAll(final int key, final com.telenav.kivakit.collections.primitive.array.scalars.LongArray values)
    {
        // If we haven't already put a value for this key
        assert isNull(indexes.get(key));
    ...
    {
        putAll(key, (com.telenav.kivakit.collections.primitive.array.scalars.LongArray) values);
    }
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        values = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.LongArray.class);
