...
package com.telenav.kivakit.collections.primitive.list.store;
...
public class LongLinkedListStore extends PrimitiveListStore
{
     ...
     */
    public int addAll(int list, final com.telenav.kivakit.collections.primitive.array.scalars.LongArray values)
    {
