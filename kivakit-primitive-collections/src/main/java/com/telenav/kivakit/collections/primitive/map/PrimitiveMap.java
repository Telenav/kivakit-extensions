...
package com.telenav.kivakit.collections.primitive.map;

import com.esotericsoftware.kryo.Kryo;
import com.esotericsoftware.kryo.io.Input;
import com.esotericsoftware.kryo.io.Output;
import com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator;
...
public abstract class PrimitiveMap extends PrimitiveCollection
{
    ...
    private com.telenav.kivakit.collections.primitive.map.HashingStrategy hashingStrategy;
    ...
    protected com.telenav.kivakit.collections.primitive.map.HashingStrategy hashingStrategy()
    {
    ...
    protected String toString(final com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator keys, final com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator values,
                              final MapToString toStringer)
    {
        return Indent.by(4, toString(keys, values, ", ", 5, "\n", toStringer));
    }

    protected String toString(final com.telenav.kivakit.collections.primitive.iteration.PrimitiveIterator keys, final PrimitiveIterator values, final String separator,
