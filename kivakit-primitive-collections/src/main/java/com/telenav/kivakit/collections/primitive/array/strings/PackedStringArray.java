...
package com.telenav.kivakit.collections.primitive.array.strings;

import com.esotericsoftware.kryo.Kryo;
import com.esotericsoftware.kryo.io.Input;
import com.esotericsoftware.kryo.io.Output;
import com.telenav.kivakit.collections.primitive.array.PrimitiveArray;
...
public class PackedStringArray extends PrimitiveArray
{
     ...
     */
    private com.telenav.kivakit.collections.primitive.array.scalars.SplitByteArray asciiCharacters;
     ...
     */
    private com.telenav.kivakit.collections.primitive.array.scalars.SplitCharArray unicodeCharacters;
    ...
    public void read(final Kryo kryo, final Input input)
    {
        ...
        asciiCharacters = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.SplitByteArray.class);
        unicodeCharacters = kryo.readObject(input, com.telenav.kivakit.collections.primitive.array.scalars.SplitCharArray.class);
    ...
    {
        super.onInitialize();
        asciiCharacters = new com.telenav.kivakit.collections.primitive.array.scalars.SplitByteArray(objectName() + ".ascii");
        asciiCharacters.initialSize(Estimate._65536).initialize();

        unicodeCharacters = new com.telenav.kivakit.collections.primitive.array.scalars.SplitCharArray(objectName() + ".unicode");
