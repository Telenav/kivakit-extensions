...
package com.telenav.kivakit.microservice.internal.microservlet.rest.plugins.jetty.filter;
...
public class JettyMicroservletFilterHolder extends FilterHolder implements ComponentMixin
{
    ...
    public void mount(String path, HttpMethod method, Microservlet<?, ?> microservlet)
    {
        filter.mount(path, method, microservlet);
    }
}
