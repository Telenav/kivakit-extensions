...
package com.telenav.kivakit.microservice.microservlet.rest.internal.plugins.jetty;
...
import com.telenav.kivakit.microservice.microservlet.rest.internal.plugins.jetty.filter.JettyMicroservletFilterHolder;
...
public class MicroservletJettyFilterPlugin extends BaseJettyFilterPlugin
{
    ...
    public void mount(final String path,
                      final MicroserviceRestService.HttpMethod method,
                      final Microservlet<?, ?> microservlet)
    {
        filterHolder.mount(path, method, microservlet);
    }
}
